...
class SVFENDDataset(Dataset):
    ...
    def __init__(self, datamode='title+ocr', train_or_test='train'):  #标题+转录
        ...
        # gpt生成的文本分析
        # with open(os.path.join('data/gpt_description', 'gpt_rag2_description_' + train_or_test + '.pkl'), "rb") as fr:
        # with open(os.path.join('data/gpt_description', 'gpt_rag4_description_' + train_or_test + '.pkl'), "rb") as fr:
        with open(os.path.join('data/gpt_description', 'gpt_rag6_description_' + train_or_test + '.pkl'), "rb") as fr:
        # with open(os.path.join('data/gpt_description', 'gpt_description_' + train_or_test + '.pkl'), "rb") as fr:
        # with open(os.path.join('data/gpt_description', 'gpt_rag_description_' + train_or_test + '.pkl'), "rb") as fr:
        # with open(os.path.join('data/gpt_description', 'gpt_lv_description_' + train_or_test + '.pkl'), "rb") as fr:
